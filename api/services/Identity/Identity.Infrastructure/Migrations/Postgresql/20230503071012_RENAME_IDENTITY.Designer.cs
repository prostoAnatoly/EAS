...
namespace Identity.Infrastructure.Migrations.Postgresql
{
    ...
    [Migration("20230503071012_RENAME_IDENTITY")]
    partial class RENAME_IDENTITY
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Identity.Domain.Aggregates.AccessTokens.AccessToken", b =>
                {
                    ...
                    b.HasIndex("IdentityId")
                        .HasDatabaseName("ix_access_tokens_identity_id");
            ...
            modelBuilder.Entity("Identity.Domain.Aggregates.Identities.IdentityInfo", b =>
                {
                    ...
                    b.HasIndex("UserName")
                        .HasDatabaseName("ix_identities_user_name");
            ...
            modelBuilder.Entity("Identity.Domain.Aggregates.AccessTokens.AccessToken", b =>
                {
                    b.HasOne("Identity.Domain.Aggregates.Identities.IdentityInfo", null)
                        .WithMany()
                        .HasForeignKey("IdentityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_access_tokens_identities_identity_info_temp_id");
                    ...
                    b.OwnsOne("Identity.Domain.Aggregates.AccessTokens.RefreshToken", "RefreshToken", b1 =>
                        {
                            ...
                            b1.ToTable("access_tokens");

                            b1.WithOwner()
                                .HasForeignKey("AccessTokenId")
                                .HasConstraintName("fk_access_tokens_access_tokens_id");
                        });
